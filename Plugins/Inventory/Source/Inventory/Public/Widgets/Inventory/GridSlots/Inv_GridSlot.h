...
public:
	...
	FORCEINLINE void SetTileIndex(const int32 Index){TileIndex = Index;};
	...
	FORCEINLINE UInv_ItemPopUp* GetItemPop() const{return ItemPopUp.Get();};
...
private:
	...
	UFUNCTION()
	void OnNativeDestructed(UUserWidget* Menu);
};
